...
namespace QuanLyDienThoai1.Model
{
    public class SanPham
    {
        ...
        public SanPham(string ma_san_pham, string ten_san_pham, int kich_thuoc, string mau_sac, int so_luong, double don_gia)
        {
            ...
            public SanPham(SanPham obj)
            {

            this.ma_san_pham = obj.ma_san_pham;
            this.ten_san_pham = obj.ten_san_pham;
            this.kich_thuoc = obj.kich_thuoc;
            this.mau_sac = obj.mau_sac;
            this.so_luong = obj.so_luong;
            this.don_gia = obj.don_gia;
        }
        }
