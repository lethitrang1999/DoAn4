...
namespace QuanLyDienThoai1.Presentation
{
    ...
    public class SanPhamView
    {
        ...
        public void HienThi()
        {
            ...
            Console.WriteLine("Ma \t Ten San Pham \t Kich Thuoc \t Mau sac \t So luong  \t Don Gia ");
        ...
        {
            SanPham sp = new SanPham();
            return sp.MaSanPham + "\t" + sp.TenSanPham + "\t" + sp.KichThuoc + "\t" + sp.MauSac + "\t" + sp.SoLuong + "\t" + sp.DonGia;
        }
        ...
        {//
           List<SanPham> ds = new List<SanPham>();
            ...
            // return t;
            Console.Write("Tổng tiền là : {0}", t);
        }
        //public void hientien()
        //{
        //    Console.Write("Tổng tiền của sản phẩm là: " + tinhtien());
        //}
        public void TimKiem()
        {
